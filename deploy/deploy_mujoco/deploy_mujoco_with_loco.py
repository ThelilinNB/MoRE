"""
G1 16DOF Loco Sim2Sim Deployment Script for MuJoCo
对应 g1_16dof_loco_config.py 的策略 (num_obs=57, 无 gait_cmd)

Usage: python deploy/deploy_mujoco/deploy_mujoco_with_loco.py g1_16dof_loco.yaml
"""
import time
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="G1 16DOF Loco Sim2Sim Deployment")
