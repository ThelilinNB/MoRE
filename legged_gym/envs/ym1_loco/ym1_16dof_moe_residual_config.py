...
class ym1_16Dof_MoE_Residual_Cfg( LeggedRobotCfg ):
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_actions = 16
        amp_motion_files_list = ['./resources/ym1_amp_data/lafan_walk+run_50FPS', './resources/ym1_amp_data/lafan_high_knees_50FPS','./resources/ym1_amp_data/lafan_squat_50FPS'] 
    ...
    class depth(LeggedRobotCfg.depth):
        ...
        # body mask
        add_body_mask = False  # 初始关闭，将在body_mask_start_step后自动启用
        body_mask_path = './body_mask_data/collected_ym1_16dof_loco.npz'
        body_mask_start_step = 10000  # 从5000轮开始启用body mask
        # crop depth
        crop_depth = True
    ...
    class asset( LeggedRobotCfg.asset ):
        ...
        feet_indicator_offset = [[-0.05, 0, -0.035], [-0.1, 0, -0.035], [0, 0, -0.035], [0.05, 0, -0.035], [0.1, 0, -0.035],  [0.165, 0, -0.035]]
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        feet_min_lateral_distance_target = 0.20
        class scales:
            """ locomotion rewards """
            ...
            feet_stumble = -1.0
            torques = -1e-5
            arm_joint_deviation = -2.0  # 增大手臂偏离惩罚，强制对称
            arm_symmetry = -5.0  # 新增：惩罚左右手臂不对称
            dof_pos_limits = -2.0
            dof_vel_limits = -1.0
            torque_limits = -1.0
...
class ym1_16Dof_MoE_Residual_CfgPPO( LeggedRobotCfgPPO ):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        run_name = ''
        experiment_name = 'ym1_16dof_resi_moe'
        save_interval = 500

        load_loco_policy = True
        loco_expert_ckpt_path = "/home/ps/lpl/MoRE/logs/ym1_16dof_loco/Jan16_16-49-16_/model_36600.pt"  # 替换为你的实际模型路径

        num_gait = len(ym1_16Dof_MoE_Residual_Cfg.env.amp_motion_files_list)
